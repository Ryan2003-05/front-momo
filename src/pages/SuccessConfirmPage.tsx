      ...
      <aside className="flex w-55 shrink-0 flex-col border-r border-blue-900 bg-blue-950 text-white">
        ...
        <nav className="flex-1 px-3 py-4 text-[13px]">
          <button
            ...
            className="mb-1 flex w-full items-center gap-2 rounded-md px-3 py-2 text-left text-blue-100 hover:bg-white/10"
          >
            <span>▦</span>
            Tableau de bord
          </button>
          <button
            ...
            className="mb-1 flex w-full items-center gap-2 rounded-md bg-green-500/20 px-3 py-2 text-left font-semibold text-green-300"
          >
            <span>⊕</span>
            Nouveau paiement
          </button>
      ...
      <main className="relative flex min-w-0 flex-1 flex-col">
        <div className="flex flex-1 items-start justify-center overflow-y-auto p-6">
          <section className="w-full max-w-md rounded-lg border border-gray-200 bg-white p-8">
            <h1 className="text-center text-2xl font-semibold text-green-700">Paiement recu !</h1>
            <p className="mb-6 text-center text-sm text-gray-500">La transaction a ete confirmee avec succes</p>
            <div className="mb-5 rounded-md border border-green-200 bg-green-50 p-4 text-center">
              <p className="text-3xl font-semibold text-green-700">12 500 FCFA</p>
            </div>
